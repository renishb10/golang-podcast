...
type ItunesApiService struct{}

func NewItunesApiService() *ItunesApiService {
...
func (ias *ItunesApiService) Search(term string) (SearchResponse, error) {
	searchUrl := url.URL{
		Scheme: "https",
	...
	queryString := searchUrl.Query()
	queryString.Set("entity", "podcast")
	queryString.Set("term", term)

	searchUrl.RawQuery = queryString.Encode()
